...
class Environment(gym.Env):
    ...
    def animate_ball(self):
        ...
        if self.ball_animation:
            ...
            goalkeeper_box = pygame.Rect((current_goalkeeper_pos[0] - self.goalkeeper_width // 2),
                                         current_goalkeeper_pos[1] - self.goalkeeper_height // 2,
                                         self.goalkeeper_width, self.goalkeeper_height)

            ball_box = pygame.Rect(float(predicted_position[0] - self.ball_radius),
                                   float(predicted_position[1] - self.ball_radius),
    ...
    def predict_ball_position(self):
        # Use a simple linear prediction for now
        ...
        if ball_speed > 0:
            ...
            # Predict the ball's position at a future time step
            prediction_time = 0.5  # Adjust this value as needed
            predicted_position = self.ball + direction * ball_speed * prediction_time
